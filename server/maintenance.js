...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://myce.world/">
        <img src="https://myce.world/wp-content/uploads/2018/12/MYCELOGO_WHITE-FULL.png" title="Myce Worl"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Myce Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="https://myce.world/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
