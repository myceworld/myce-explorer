    ...
    <Card title="Estimated Earnings (COIN/BTC/USD)">
      <div className="row">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(day) } YCE / { nbtc(day * coin.btc) } BTC / { nusd(day * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(week) } YCE / { nbtc(week * coin.btc) } BTC / { nusd(week * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(month) } YCE / { nbtc(month * coin.btc) } BTC / { nusd(month * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(year) } YCE / { nbtc(year * coin.btc) } BTC / { nusd(year * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col">
